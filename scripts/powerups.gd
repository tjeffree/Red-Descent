...
const POWERUPS: Array = [
	# --- Drill / mining ---------------------------------------------------------
	{ "id": "overclock", "name": "OVERCLOCK CORE", "duration": 20.0, "min_depth": 0.0,
	...
	{ "id": "diamond_bit", "name": "ADAMANT BIT", "duration": 10.0, "min_depth": 0.0,
	...
	# --- Thermal / energy -------------------------------------------------------
	{ "id": "cryo", "name": "CRYO FLUSH", "duration": 15.0, "min_depth": 0.0,
	...
	{ "id": "overcharge", "name": "OVERCHARGE", "duration": 12.0, "min_depth": 0.0,
	...
	{ "id": "heatsink", "name": "HEAT-SINK SKIN", "duration": 15.0, "min_depth": 0.0,
	...
	{ "id": "phase_dash", "name": "PHASE DRIVE", "duration": 12.0, "min_depth": 0.0,
	...
	{ "id": "hover", "name": "HOVER FIELD", "duration": 60.0, "min_depth": 0.0,
